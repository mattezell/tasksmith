...
- **README compiled prompts list inaccurate** — listed "Template — task instructions with your prompt injected" as step 7. Templates were removed in v1.0.0; skills are loaded natively by Claude Code via `--add-dir`, not injected into the prompt. Updated to accurately describe skill discovery.
